...
namespace BethanysPieShop.Services
{
    public class TicketDataService : ITicketDataService
    {
        ...
        public TicketDataService(ITicketRepository TicketRepository, OpenAIClient openAIClient, IOptions<ModelSettings> modelSettings, IPieRepository pieRepository)
        {
        ...
        private async Task SummarizeTicket(Ticket ticket, Pie pie)
        {
            ...
            var prompt = $$"""
                ...
                Ensure that no markdown or HTML is included in your output, so never include any characters like # or < or `.
                """;
